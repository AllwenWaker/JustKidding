...
> [!/]lock [group_id] [name|flood|photo|member|bots|ads|tag|join|arabic|leave]
>>[!/]lock 123456789 name
>>>This command will lock name|flood|photo|member|bots|ads|tag|join|arabic|leave of [group_id]


### Unlock groups name|flood|photo|member
> [!/]unlock [group_id] [name|flood|photo|member|bots|ads|tag|join|arabic|leave]
>>[!/]unlock 123456789 name
>>>This command will unlock name|flood|photo|member|bots|ads|tag|join|arabic|leave of [group_id]
...
### group name|member|arabic|flood|bots|ads|tag|join|leave lock
>[!/]lock [name|member|arabic|flood||bots|ads|tag|join|leave]
>>[!/]lock flood
>>>This command will lock name|member|arabic|flood||bots|ads|tag|join|leave of groups

### group name|member|arabic|flood||bots|ads|tag|join|leave unlock
>[!/]unlock [name|member|arabic|flood||bots|ads|tag|join|leave]
>>[!/]unlock flood
>>>This command will unlock name|member|arabic|flood||bots|ads|tag|join|leave of groups
...
[@UltronTeam](https://telegram.me/UltronTeam)
